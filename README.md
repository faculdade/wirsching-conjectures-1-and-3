...
| | DOI | resolves to |
|---|---|---|
| `v1.0.4` | the DOI Zenodo mints for this release; see the concept DOI's landing page | this exact snapshot, the one the paper cites |
...
The paper cites the concept DOI together with the release tag `v1.0.4`.
...
For `v1.0.4` that is the submitted manuscript exactly.
