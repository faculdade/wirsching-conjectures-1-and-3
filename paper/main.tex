...
Every section, equation and result reference to \cite{Wirsching2003} in
what follows is to the published article, and each was checked against
it.\footnote{The numbering agrees throughout with the author's
...
proof: $E(18)=1.0020653\ldots\ge1$, $E(19)=0.9570558\ldots<1$); this is the threshold kept as the
...
\texttt{v1.0.4}, whose snapshot carries this paper, its source and the
...
$F_\varphi(s)=1-F_\varphi(1-s)$. Second, $X$ charges every subinterval
of $(0,1)$ in the following sense: $0<F_\varphi(s)<1$ for $0<s<1$.
