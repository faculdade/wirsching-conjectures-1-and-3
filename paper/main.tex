...
archived at \texttt{doi:10.5281/zenodo.22119157}, release \texttt{v1.0.2},
commit \texttt{0248f42}. That is the version DOI, which is fixed to this
...
of this paper as it stood at the release. Zenodo mints a version DOI
only when the release is made, so that copy is always at least one
revision behind the paper of record; the repository's default branch
...
\bibitem{Wirsching2003} G.\ J.\ Wirsching, \emph{On the problem of
  ...
  which we also read. For the reader's convenience, \S1 begins on
  p.~773, \S2 on p.~776, \S3 on p.~778, \S4 and \S5 on p.~780, \S6 on
  p.~783 and \S7 on p.~784; Definition~1 is on p.~772, Theorem~1 on
  p.~775, Conjecture~1 on p.~778, Theorem~2 on p.~780, Theorem~6 and
