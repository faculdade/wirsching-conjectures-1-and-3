...
(justified rigorously, uniformly, by Theorem 7.5 of the paper), not by oscillatory
...
This is supporting numerical evidence for Theorem 10.1, not a substitute for
the proof, which is in section 10 of the paper archived in paper/ of this
repository.
"""
import mpmath as mp
...
def phi_saddle(t, terms=250):
    """Real-variable saddlepoint approximation to phi(t), Theorem 7.5 of the paper."""
    t = mp.mpf(t)
...
if __name__ == "__main__":
    ...
    print("visible already by l=50. Full convergence to 0.204988 (Theorem 10.1's")
